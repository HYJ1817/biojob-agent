...
const zh = {
  ...
  openFacts: '检查事实',
  candidateTitle: '候选岗位',
  candidateSubtitle: '先打开原页面核验岗位；合适就点“保留”，它才会进入投递表。',
  ...
  exportTracker: '导出 Excel 投递表',
  generateResume: '生成 Word 简历',
  resumePreparingOnly: '先把状态切换到“准备中”才能生成简历',
  ...
  importResume: '导入基础简历',
  importResumeHint: '支持 Word / PDF；解析结果只会成为待确认事实。',
  noFacts: '还没有个人事实',
  ...
  rejected: '已拒绝',
  sourcesTitle: '岗位来源',
  sourcesSubtitle: '点“运行全部启用来源”寻找岗位；自动结果需核验，官方入口可直接打开。',
  automaticSources: '自动发现来源',
  officialPortals: '官方核验入口',
  runAllSources: '运行全部启用来源',
  openPortal: '打开招聘页',
  sourceFailedHint: '网站限制或网络异常；其他来源仍可继续运行',
  batchNew: '新增',
  batchMerged: '合并重复',
  batchPending: '待核验',
  batchFailed: '失败来源',
...
const en: BioJobCopy = {
  ...
  exportTracker: 'Export Excel tracker',
  generateResume: 'Generate Word resume',
  resumePreparingOnly: 'Move the application to Preparing before resume generation.',
  ...
  importResume: 'Import base resume',
  importResumeHint: 'Word / PDF imports become pending facts for your review.',
  ...
  automaticSources: 'Automatic discovery',
  officialPortals: 'Official verification portals',
  runAllSources: 'Run all enabled sources',
  openPortal: 'Open careers page',
  sourceFailedHint: 'Site restriction or network failure; other sources can still run',
  batchNew: 'New',
  batchMerged: 'Duplicates merged',
  batchPending: 'Pending verification',
  batchFailed: 'Failed sources',
