...
export const zh: Translations = {
  ...
  install: {
    ...
    oneTimeTitle: 'BioJob Agent 需要一次性安装',
    ...
    setupChoiceTitle: '设置 BioJob Agent',
    ...
    installLocalTitle: '在本机安装 BioJob Agent',
    installLocalDesc: '安装 BioJob Agent，创建 Python 环境，并在这台电脑上运行后端。',
    localStartUnavailable: '无法启动本地安装。请重启 BioJob Agent 后重试。',
  ...
  onboarding: {
    headerTitle: '开始设置 BioJob Agent',
    headerDesc: '连接模型提供方即可开始对话。大多数选项只需一次点击。',
    preparingInstall: 'BioJob Agent 正在完成首次安装。',
    starting: '正在启动 BioJob Agent…',
